    ...
    func setImageNames(images:Array<Any>) {
        ...
        if imageNames.count > 0 {
            ...
            for i in 0..<imageNames.count {
                ...
                if sub is String{
                    imageView.kf.setImage(with: URL(string: imageNames[i] as! String))
                }
                if sub is UIImage{
            ...
            scrollView.contentSize = CGSize(width: self.frameW * CGFloat(imageNames.count), height: self.frameH);
